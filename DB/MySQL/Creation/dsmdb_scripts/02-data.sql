...
GRANT ALL PRIVILEGES ON `ac1`.* TO 'systemsmanager'@'%';
CREATE User 'smapp'@'%' IDENTIFIED BY 'smapp123';
GRANT SELECT, INSERT, UPDATE, DELETE, EXECUTE, SHOW VIEW ON `ac1`.* TO 'smapp'@'%';
...
INSERT INTO SubscriberRestrictions(originationRestrictionId, terminationRestrictionId)
    ...
    ((SELECT id FROM OriginationRestrictions WHERE name = '00'), (SELECT id FROM TerminationRestrictions WHERE name = '1')),
