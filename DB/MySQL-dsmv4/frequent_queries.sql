...
CALL getBroadbandByBroadbandPort(15);
CALL getBroadbandInstallationsList("2017-12-01", "2019-11-28");
CALL getBroadbandPortsList();
CALL getBroadbandUninstallationsList("2017-12-14", "2017-12-15");
CALL getDistributionWiringByBlockPosition(5, '15AB');
CALL getDistributionWiringByBroadbandPort(54);
CALL getDistributionWiringByPhoneNumber(1, '6353');
...
CALL getModifiedSubscribersDataList("2019-10-1", "2019-11-11");
...
CALL getSubscribersDataModificationList("2019-10-26", "2019-11-15");
...
SELECT Wiring.id AS wiringId, Wiring.distributorId, Wiring.streetPairId, Wiring.secondStreetPairId,
    ...
    Subscribers.id AS subscriberId, PhoneNumbers.id AS phoneNumberId, PhoneNumbers.number AS phoneNumber, PhoneNumbers.officeCodeId AS phoneOfficeCodeId,
    ...
    Wiring.remarks AS wiringRemarks
		FROM Wiring
            ...
            LEFT JOIN OfficeCodes ON OfficeCodes.id = PhoneNumbers.officeCodeId
				WHERE OfficeCodes.code = 454 AND PhoneNumbers.number = '0806';
...
--DELETE FROM DSLAMsBoards
	WHERE id = 50;

--DELETE FROM BroadbandPorts
	WHERE boardId = 50;
